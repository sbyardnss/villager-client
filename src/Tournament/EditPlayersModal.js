...
export const EditPlayersModal = ({ activeTournamentObj, setEdit, playedRounds }) => {
    ...
    //     }
    //     for (const pairing of oldPairingsSimplified){
    //         playerOpponentsReferenceObj[pairing[0]]?.push(pairing[1])
    //         playerOpponentsReferenceObj[pairing[1]]?.push(pairing[0])
    //     }
    //     const newRoundMatchup = []
    //     for (const player of playerReference){
    //         const opponent = playerReference.find(p => {
    //             return !playerOpponentsReferenceObj[player].find(rp => rp === p) && !playerOpponentsReferenceObj[p].find(rp => rp === player) && p !== player
    //         })
    //         const opponentIndex = playerReference.indexOf(opponent)
    //         playerReference.splice(opponentIndex, 1)
    //         const playerIndex = playerReference.indexOf(player)
    //         playerReference.splice(playerIndex, 1)
    //         playerOpponentsReferenceObj[player].push(opponent)
    //         playerOpponentsReferenceObj[opponent].push(player)
    //         // console.log(opponent)
    //         // console.log(playerReference)
    //         newRoundMatchup.push([player, opponent])
    //     }
    //     console.log(newRoundMatchup)
