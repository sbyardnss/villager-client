...
import { getActiveUserGames, getOpenChallenges, acceptChallenge, deleteChallengeGame, deleteCommunityPost, getAllCommunityPosts, getAllGames, getAllPlayers, getAllTournaments, getMyChessClubs, getPuzzles, getTournament, sendNewGame, submitNewPostToAPI } from "../ServerManager"
...
export const HomePage = () => {
  ...
  useEffect(
    () => {
      Promise.all([getOpenChallenges(), getAllCommunityPosts(), getActiveUserGames()])
